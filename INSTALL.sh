...
#Configurtion for HOPPER
#JUN 2014
#fftw/3.3.0.4

module load /opt/cray/modulefiles/fftw/3.3.0.4
module load /usr/common/usg/Modules/modulefiles/openmpi_ccm/1.4.5_mom
